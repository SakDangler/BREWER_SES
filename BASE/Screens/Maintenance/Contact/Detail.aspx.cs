...
namespace BASE.Screens.Maintenance.Contact
{
    public partial class Detail : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("/Screens/Maintenance/Contact/Edit?ID=" + CurrentItem.ContactID);
        }

        protected void btnCommittee_Click(object sender, EventArgs e)
        {
            Response.Redirect("/Screens/Maintenance/Contact/ManageRoles.aspx?ID=" + CurrentItem.ContactID);
        }
